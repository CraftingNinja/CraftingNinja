...
<template>
    <SectionHead title="Log in" :center="true" />
    ...
    <AuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="block mt-4">
                <label class="flex items-center">
                    ...
                    <span class="ml-2 text-xs font-bold uppercase text-gray-900 dark:text-white">Remember Me</span>
                </label>
            </div>
        ...
        <hr class="mt-8 pb-8 border-t-gray">
