...
<template>
    <SectionHead title="Register" :center="true" />
    ...
    <AuthenticationCard>
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                ...
                />
                <!--<p class="mt-3 text-sm leading-6 text-gray-600 dark:text-gray-200">-->
                <!--    Do me a favor: don't use your Square Enix credentials.-->
                <!--</p>-->
